...
// Credit is an account-level observation with freshness independent of quota
// windows. Merge it separately so a newer unavailable observation clears an
// older value, while a transient result can retain the last valid value.
